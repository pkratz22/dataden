...
class TestDateSeriesGenerator(unittest.TestCase):
    ...
    def test_generate_date_series_before_original(self):
        seed(17)
        input_test_series = pd.Series(
            data={
                1: datetime(2022, 1, 1),
                2: datetime(2022, 1, 10)
            },
            index=[1, 2]
        )
        output_test_series = pd.Series(
            data={
                1: datetime(2021, 12, 31),
                2: datetime(2022, 1, 8)
            },
            index=[1,2]
        )
    ...
    def test_generate_date_series_equal_original(self):
        seed(17)
    ...
    def test_generate_date_series_after_original(self):
        seed(17)
        input_test_series = pd.Series(
            data={
                1: datetime(2022, 1, 1),
